...
# Spacy code was done with the help of the tutorials/documentation at the Spacy website
...
for index, row in TRAINING_DATA.iterrows():
    # Run Spacy's NLP on the sentence under E1 and E2
    doc = nlp(str(row['E1']))
    doc2 = nlp(str(row['E2']))
    ...
    combination = numpy.concatenate([doc.vector, doc2.vector])
